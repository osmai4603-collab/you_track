...
class _IssuesTreeViewState extends State<IssuesTreeView> {
        ...
        if (state is IssuesLoaded) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: tree.map((node) => _TreeNodeWidget(
                node: node,
                depth: 0,
  ...
  List<_TreeNode> _buildTree(List<Issue> issues) {
    ...
    final roots = issues.where((i) =>
        i.parentId == null || !issueMap.containsKey(i.parentId)).toList();
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  _InlineStateChip(state: issue.state, textTheme: textTheme),
                  const SizedBox(width: AppSpacing.small),
...
class _InlineStateChip extends StatelessWidget {
  ...
  const _InlineStateChip({required this.state, required this.textTheme});
