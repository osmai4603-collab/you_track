                ...
                child: Column(
                  ...
                  children: [
                    TimeTrackingToggle(
                      state: state,
                      onToggle: () =>
                          context.read<TimeTrackingConfigCubit>().toggleEnabled(),
                    ),
                    AnimatedSize(
                              ...
                              children: [
                                ...
                                BlocProvider<WorkTypesCubit>(
                                  create: (_) => WorkTypesCubit(
                                    getWorkTypesUseCase: sl(),
                                    addWorkTypeUseCase: sl(),
                                    updateWorkTypeUseCase: sl(),
                                    deleteWorkTypeUseCase: sl(),
                                    reorderWorkTypesUseCase: sl(),
                                ...
                                BlocProvider<CustomAttributesCubit>(
                                  create: (_) => CustomAttributesCubit(
                                    getAttributesUseCase: sl(),
                                    addAttributeUseCase: sl(),
                                    updateAttributeUseCase: sl(),
                                    deleteAttributeUseCase: sl(),
                                    projectId: widget.projectId,
                                  ),
