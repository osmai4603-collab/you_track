      ...
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
            ...
            if (!hasFields)
              _buildNoFieldsMessage(context)
            else ...[
              _buildEstimationFieldDropdown(context, config, availableFields),
              const SizedBox(height: 16),
              _buildSpentTimeFieldDropdown(context, config, availableFields),
  ...
  Widget _buildEstimationFieldDropdown(
    ...
    return DropdownButtonFormField<String>(
      ...
      items: [
        ...
        ...fields.map((field) => DropdownMenuItem<String>(
              value: field.id,
